...
public class OldVersionsUtils {
    ...
    public static void selectOpenGlVersion(JMinecraftVersionList.Version version){
        ...
        try {
            String openGlVersion = new SimpleDateFormat("yyyy-MM-dd", Locale.ENGLISH)
                    .parse(creationDate.substring(0, creationDate.indexOf("T")))
                    .before(new Date(2011-1900, 6, 8)) ? "1" : "2";
