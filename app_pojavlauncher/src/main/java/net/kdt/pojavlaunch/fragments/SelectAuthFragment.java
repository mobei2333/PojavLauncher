...
public class SelectAuthFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button mMojangButton = view.findViewById(R.id.button_mojang_authentication);
        Button mLocalButton = view.findViewById(R.id.button_local_authentication);

        mMojangButton.setOnClickListener(v -> Tools.swapFragment(requireActivity(), MojangLoginFragment.class, MojangLoginFragment.TAG, false, null));
