...
public class ProfileEditorFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mDefaultRenderer.setAdapter(new ArrayAdapter<>(getContext(), android.R.layout.simple_spinner_dropdown_item, renderList));
        ...
        mVersionSelectButton.setOnClickListener(v -> {
            ...
            ExpandableListAdapter adapter = new VersionListAdapter((JMinecraftVersionList)
                    ExtraCore.getValue(ExtraConstants.RELEASE_TABLE), mDefaultVersion.getContext());
